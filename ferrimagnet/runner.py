...
def main():
    ...
    results = sweep.run_all_parallel(j_stt_arr, j_she, flips)

    # Plot the results using the Plotter class
    plotter = Plotter(figure_path, results, device_classes, param_sets, j_stt_arr, j_she, flips, data_folder, ["temperature", "alpha_b"])
    plotter.plot_scurve()
